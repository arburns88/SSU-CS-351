...
struct TComplex
{
    ...
    __device__ TComplex &operator-=(const TComplex &a)
    {
        x -= a.x;
        y -= a.y;
        return *this;
    ...
    __device__ __host__ friend TComplex operator+(const TComplex &a, const TComplex &b)
    {
        return TComplex(a.x + b.x, a.y + b.y);
    }

    __device__ friend TComplex operator*(const TComplex &a, const TComplex &b)
    {
